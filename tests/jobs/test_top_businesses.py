...
from src.jobs import TopBusinesses
from src.utils.exception import BigQueryException


class TestSuiteTopBusinesses:

    def test_top_businesses(self, resource):
        top = 10
